        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-64 bg-[var(--bg-card)] border border-[var(--border)] p-4 z-50 shadow-2xl">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="flex-1 py-1.5 text-center text-xs font-semibold uppercase tracking-wider border border-[var(--border)] text-[#888888] hover:text-white hover:border-[#7C3AED] transition-all"
            >
              View Profile
            </Link>
            <button
