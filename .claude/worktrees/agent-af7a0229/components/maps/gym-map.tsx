        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-72 bg-[var(--bg-card)] border border-[var(--border)] p-4 z-50 shadow-2xl">
          ...
          {setSuccess === selectedCard.gym.place_id ? (
            ...
            <button
              ...
              className="w-full py-2 bg-[#7C3AED] text-white text-xs font-semibold uppercase tracking-wider hover:shadow-[0_0_15px_rgba(124,58,237,0.4)] disabled:opacity-50 transition-all"
            >
