    ...
    <div ref={ref} className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-[var(--bg)] border border-[var(--border)] text-[var(--text)] pl-9 pr-3 py-2.5 text-sm focus:border-[#7C3AED] focus:outline-none placeholder:text-[#444444]"
        />
      </div>
