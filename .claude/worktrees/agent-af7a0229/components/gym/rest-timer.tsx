        ...
        <div className="relative w-16 h-16 shrink-0">
          <svg className="w-16 h-16 -rotate-90" viewBox="0 0 64 64">
            ...
            <circle
              ...
              r="28"
              fill="none"
              stroke={remaining === 0 ? '#00CC44' : '#7C3AED'}
              strokeWidth="4"
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#7C3AED] text-white text-xs font-semibold uppercase tracking-wider hover:shadow-[0_0_12px_rgba(124,58,237,0.4)] transition-all"
            >
            ...
            <button
              type="button"
              onClick={reset}
              className="flex items-center gap-1.5 px-3 py-1.5 border border-[var(--border)] text-[#888888] text-xs hover:text-white hover:border-[#7C3AED] transition-all"
            >
