...
const QUICK_ACTIONS = [
  { href: '/discover', label: 'Odkryj', icon: Compass, color: '#7C3AED' },
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              <div>
                ...
                <h1 style={{ color: 'white', fontWeight: 800, fontSize: 22, letterSpacing: -0.5, lineHeight: 1.2 }}>
                  {username ? `Cześć, ${username}! 👋` : 'TrainingTinder'}
                </h1>
              </div>
              <div style={{
            ...
            <Link href="/discover" style={{ textDecoration: 'none' }}>
              <div style={{
                ...
                <div style={{
                  ...
                  <Compass style={{ width: 20, height: 20, color: '#7C3AED' }} />
                </div>
                <div>
        ...
        {feed.length > 0 && (
          <div style={{ padding: '0 16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              ...
              <Link href="/feed" style={{ color: '#7C3AED', fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>
                Zobacz więcej
              </Link>
            </div>
      ...
      <div className="hidden md:block p-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/feed" className="text-sm font-semibold flex items-center gap-1" style={{ color: '#7C3AED', textDecoration: 'none' }}>
