          ...
          <div className="flex items-center gap-4 mt-5 pt-4 border-t border-[var(--border)]">
            <button
              ...
              className={`flex items-center gap-2 text-sm transition-colors ${
                isLiked ? 'text-[#7C3AED]' : 'text-[#555555] hover:text-[#7C3AED]'
              } disabled:opacity-50`}
            >
        ...
        <div className="mb-4">
          ...
          <form onSubmit={handleSubmitComment} className="flex gap-3">
            <textarea
              ...
              rows={3}
              className="flex-1 bg-[var(--bg-card)] border border-[var(--border)] text-white placeholder-[#444] px-4 py-3 text-sm focus:outline-none focus:border-[#7C3AED]/50 transition-colors resize-none"
            />
            <button
              type="submit"
              disabled={submittingComment || !commentText.trim()}
              className="px-4 py-3 bg-[#7C3AED] text-white hover:shadow-[0_0_20px_rgba(124,58,237,0.4)] transition-all disabled:opacity-50 flex items-center justify-center self-stretch"
            >
              {submittingComment ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
