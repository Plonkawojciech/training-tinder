      ...
      {!loading && sorted.length >= 3 && (
        <div className="grid grid-cols-3 gap-4 mb-8">
          ...
          <Link href={`/profile/${sorted[1].clerkId}`}>
            <div className="bg-[var(--bg-card)] border border-[var(--border)] p-4 text-center card-hover mt-8">
          ...
          <Link href={`/profile/${sorted[0].clerkId}`}>
            <div
              className="bg-[var(--bg-card)] border p-4 text-center card-hover"
        ...
        <div className="flex flex-col gap-1">
          {sorted.map((entry, index) => (
            <Link key={entry.clerkId} href={`/profile/${entry.clerkId}`}>
              <div
                className="flex items-center gap-4 p-4 bg-[var(--bg-card)] border card-hover"
                style={
                  entry.isCurrentUser
                    ? { borderColor: '#7C3AED' }
                    : { borderColor: '#2A2A2A' }
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-white text-sm truncate">
                    ...
                    {entry.isCurrentUser && (
                      <span className="ml-2 text-[10px] text-[#7C3AED] uppercase tracking-wider">You</span>
                    )}
                  </p>
