                ...
                <div key={gym.place_id} className="bg-[var(--bg-card)] border border-[var(--border)] p-4 flex flex-col gap-3">
                  ...
                  {successGym === gym.place_id ? (
                    ...
                    <button
                      ...
                      className="mt-auto py-2 bg-[#7C3AED] text-white text-xs font-semibold uppercase tracking-wider hover:shadow-[0_0_15px_rgba(124,58,237,0.4)] disabled:opacity-50 transition-all"
                    >
