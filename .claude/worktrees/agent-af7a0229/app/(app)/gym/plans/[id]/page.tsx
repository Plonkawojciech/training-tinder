                        ...
                        {dayNames.map((day) => {
                          ...
                          return (
                            <div key={day} className="p-3 bg-[var(--bg-card)] border border-[var(--border)]">
                              <p className="text-xs font-bold text-[#7C3AED] uppercase tracking-wider mb-1">{day}</p>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] p-6">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            className="w-full bg-[var(--bg)] border border-[var(--border)] text-[var(--text)] px-3 py-2.5 text-sm focus:border-[#7C3AED] focus:outline-none resize-none h-20 placeholder:text-[#444444]"
          />
        </div>
