    ...
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        ...
        <select
          ...
          className="bg-[var(--bg-card)] border border-[var(--border)] text-sm text-[#888888] px-2 py-1 focus:border-[#7C3AED] focus:outline-none"
        >
        ...
        {(sportFilter || difficultyFilter) && (
          <button
            ...
            className="text-xs text-[#7C3AED] flex items-center gap-1"
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between p-3 border border-[var(--border)]">
                ...
                <button
                  ...
                  style={{ background: form.isPublic ? '#7C3AED' : '#2A2A2A' }}
                >
                  <div
