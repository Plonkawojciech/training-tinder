    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-[var(--bg-card)] border border-[var(--border)] p-4 text-center">
          <div className="w-8 h-8 bg-[rgba(124,58,237,0.1)] border border-[rgba(124,58,237,0.2)] flex items-center justify-center mx-auto mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/gym/log" className="text-xs text-[#7C3AED] hover:text-[#8B5CF6] flex items-center gap-1">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/gym/plans" className="text-xs text-[#7C3AED] hover:text-[#8B5CF6] flex items-center gap-1">
          ...
          {profile?.gymName && !loading && gymCheckins.length > 0 && (
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/gym/live" className="text-xs text-[#7C3AED] hover:text-[#8B5CF6] flex items-center gap-1">
                  View all <ChevronRight className="w-3 h-3" />
                </Link>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div key={item.checkin.id} className="bg-[var(--bg-card)] border border-[var(--border)] p-3 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.checkin.workoutType && (
                        <span className="text-[10px] text-[#7C3AED] border border-[#7C3AED]/30 px-1">{item.checkin.workoutType}</span>
                      )}
                    </div>
                ...
                {gymSpotters.slice(0, 2).map((s) => (
                  <div key={s.request.id} className="bg-[var(--bg-card)] border border-red-900/40 p-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {s.request.weightKg && (
                        <span className="text-xs text-[#7C3AED] border border-[#7C3AED]/30 px-1.5 py-0.5">{s.request.weightKg}kg</span>
                      )}
                    </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border)] p-4">
            ...
            <Link href="/gym/records" className="flex items-center gap-1 text-xs text-[#7C3AED] mt-3 hover:text-[#8B5CF6]">
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border)] p-4">
            ...
            <div className="flex flex-col gap-2">
              <Link href="/gym/log" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
                <span>Zaloguj Trening</span>
                <Dumbbell className="w-4 h-4" />
              </Link>
              <Link href="/gym/records" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
                <span>Rekordy Osobiste</span>
                <Trophy className="w-4 h-4" />
              </Link>
              <Link href="/gym/finder" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
                <span>Find Nearby Gym</span>
                <MapPin className="w-4 h-4" />
              </Link>
              <Link href="/gym/live" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
                <span>Find Gym Partners</span>
                <Radio className="w-4 h-4" />
              </Link>
              <Link href="/discover" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
                <span>Find Athletes</span>
                <Users className="w-4 h-4" />
              </Link>
              <Link href="/gym/plans" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
                <span>Training Plans</span>
                <ChevronRight className="w-4 h-4" />
              </Link>
              <Link href="/stats" className="flex items-center justify-between p-2.5 border border-[var(--border)] hover:border-[#7C3AED] transition-all text-sm text-[#888888] hover:text-white">
