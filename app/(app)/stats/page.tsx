...
export default function StatsPage() {
  const [activeTab, setActiveTab] = useState<'overview' | 'body' | 'records'>('overview');
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      ...
      <div className="flex border-b border-[#2A2A2A] mb-6">
        {(['overview', 'body', 'records'] as const).map((tab) => (
          <button
            key={tab}
          ...
          >
            {tab === 'overview' ? 'Overview' : tab === 'body' ? 'Body Stats' : 'PR Progress'}
          </button>
        ))}
      </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                {[
                  ...
                  <div key={stat.label} className="bg-[#111111] border border-[#2A2A2A] p-4 text-center">
              ...
              {bodyStats.length > 0 && (
                <div className="bg-[#111111] border border-[#2A2A2A] p-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={() => setActiveTab('body')} className="text-xs text-[#FF4500]">View all</button>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {bodyStats[0]?.bodyFatPct && (
                      <div className="flex items-center gap-3">
                        <Percent className="w-5 h-5 text-[#FF4500]" />
                        <div>
      ...
      {showAddStat && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="bg-[#111111] border border-[#2A2A2A] w-full max-w-md p-6">
            <div className="flex items-center justify-between mb-4">
