  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse 50% 60% at 70% 20%, rgba(99,102,241,0.15) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      >
        ...
        <div>
          <div style={{
            ...
            textTransform: 'uppercase', color: '#6366F1', marginBottom: '24px',
          }}>
            <span style={{
          ...
          <h1 style={{
            ...
            FIND<br />YOUR<br /><span style={{ color: '#6366F1' }}>PACK.</span>
          </h1>
          <p style={{
        ...
        <div style={{ display: 'flex', gap: '40px' }}>
          {[
            ...
            <div key={s.l}>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '36px', color: '#6366F1', lineHeight: 1 }}>{s.n}</div>
      ...
      <div style={{
        ...
        <p style={{ marginTop: '2rem', fontSize: '12px', color: 'rgba(255,255,255,0.25)', textAlign: 'center' }}>
          ...
          <a href="#" style={{ color: 'rgba(99,102,241,0.7)', textDecoration: 'none' }}>Terms</a>
          {' & '}
          <a href="#" style={{ color: 'rgba(99,102,241,0.7)', textDecoration: 'none' }}>Privacy Policy</a>
        </p>
      </div>
