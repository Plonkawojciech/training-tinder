    ...
    <div className="bg-[#111111] border border-[#2A2A2A] p-6 mb-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center">
          <div className="w-10 h-10 bg-[rgba(255,69,0,0.1)] border border-[rgba(255,69,0,0.2)] flex items-center justify-center mx-auto mb-2">
      ...
      <div className="mt-4 pt-4 border-t border-[#1A1A1A] flex justify-between text-xs text-[#888888]">
