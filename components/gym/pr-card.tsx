...
export function PRCard({ exerciseName, weightKg, reps, achievedAt, notes, isBig4 }: PRCardProps) {
  ...
  return (
    <div
      className="bg-[#111111] border p-4 transition-all hover:border-[#FF4500]"
      style={{ borderColor: isBig4 ? 'rgba(255,69,0,0.4)' : '#2A2A2A' }}
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2">
          <Trophy
            className="w-4 h-4 shrink-0"
            style={{ color: isBig4 ? '#FFD700' : '#FF4500' }}
          />
        ...
        {reps > 1 && (
          <div className="mb-0.5">
            <div className="flex items-center gap-1">
              ...
              <p className="text-sm text-[#FF4500] font-bold">~{oneRM}kg</p>
            </div>
